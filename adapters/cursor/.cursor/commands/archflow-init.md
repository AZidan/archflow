...
```
Then load and follow `.cursor/archflow/commands/onboard.md`.
...
2. **Copy `workflow.md` into the project's `.archflow/`:**
   - Source: `.cursor/archflow/skills/archflow/workflow.md` (the plugin's install path)
...
- `.cursor/archflow/skills/archflow/phases/` → `.archflow/phases/`
- `.cursor/archflow/skills/archflow/schemas/` → `.archflow/schemas/`
- `.cursor/archflow/skills/archflow/design-systems/` → `.archflow/design-systems/`
- `.cursor/archflow/skills/archflow/stacks/` → `.archflow/stacks/`
- `.cursor/archflow/skills/archflow/workflow.md` → `.archflow/workflow.md`
- `.cursor/archflow/skills/archflow/test-accounts.example.yaml` → `.archflow/`
...
1. **Ask the platform**, then run the picker. Both live in one place: read
   `.cursor/archflow/commands/design.md` and follow **Step 3 — `pick`** inline. It asks the
