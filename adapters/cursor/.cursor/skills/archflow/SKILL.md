...
Command bodies live in `.cursor/archflow/commands/<name>.md`. When you need to run one from
...
- `.cursor/archflow/skills/archflow/instructions.md` — agent-neutral base instructions
- `.cursor/archflow/skills/archflow/phases/` — per-phase instruction files
- `.cursor/archflow/skills/archflow/schemas/` — roadmap / release / backlog / history schemas
- `.cursor/archflow/skills/archflow/workflow.md` — git branching strategy
- `.cursor/archflow/skills/archflow/base-dsl-structure.yaml` — DSL template for design artifacts
- `.cursor/archflow/skills/archflow/mcp-registry.yaml` — curated MCP server registry
- `.cursor/archflow/skills/archflow/design-systems/` — design-system reference files, one plain
  markdown file per system (not skills, not commands — loaded by explicit path only)
- `.cursor/archflow/scripts/migrate.py` — v1.0 → v2.0 migration engine
...
`/archflow-status`: read and follow `.cursor/archflow/commands/status.md`.
