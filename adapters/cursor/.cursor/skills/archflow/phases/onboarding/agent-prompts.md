...
**Dispatch via:** delegating to the built-in `Explore` subagent
...
**Dispatch via:** delegating to the `product-strategist` subagent
...
**Dispatch via:** delegating to the `ux-designer` subagent
...
**Dispatch via:** delegating to the `api-contract-architect` subagent
...
**Dispatch via:** delegating to the `dsl-generator` subagent
...
**Dispatch via:** delegating to the `feature-planner` subagent
