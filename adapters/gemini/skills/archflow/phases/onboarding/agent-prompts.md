...
**Dispatch via:** delegating to a plain sub-agent
...
**Dispatch via:** delegating to a read-only sub-agent (built-in `codebase_investigator`)
...
**Dispatch via:** delegating to the `product-strategist` sub-agent
...
**Dispatch via:** delegating to the `ux-designer` sub-agent
...
**Dispatch via:** delegating to the `api-contract-architect` sub-agent
...
**Dispatch via:** delegating to the `dsl-generator` sub-agent
...
**Dispatch via:** delegating to the `feature-planner` sub-agent
