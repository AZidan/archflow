...
2. **Copy workflow.md, phases, schemas and design-systems into the project's `.archflow/`:**
   - Copy `.codex/archflow/skills/archflow/workflow.md` → `.archflow/workflow.md`
   - Copy `.codex/archflow/skills/archflow/phases/` → `.archflow/phases/` (skip files that already exist)
   - Copy `.codex/archflow/skills/archflow/schemas/` → `.archflow/schemas/` (skip files that already exist)
   - Copy `.codex/archflow/skills/archflow/design-systems/` → `.archflow/design-systems/` (skip files that already exist; skip the whole directory for `backend_only`)
   - Copy `.codex/archflow/skills/archflow/stacks/` → `.archflow/stacks/` (skip files that already exist)
   - Copy `.codex/archflow/skills/archflow/test-accounts.example.yaml` → `.archflow/` (skip if present)
