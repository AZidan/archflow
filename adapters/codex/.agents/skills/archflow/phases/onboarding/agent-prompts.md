...
**Dispatch via:** `spawn_agent` with no custom agent (a plain worker)
...
**Dispatch via:** `spawn_agent` with a read-only worker (`sandbox_mode = "read-only"`)
...
**Dispatch via:** `spawn_agent` targeting the `product-strategist` agent
...
**Dispatch via:** `spawn_agent` targeting the `ux-designer` agent
...
**Dispatch via:** `spawn_agent` targeting the `api-contract-architect` agent
...
**Dispatch via:** `spawn_agent` targeting the `dsl-generator` agent
...
**Dispatch via:** `spawn_agent` targeting the `feature-planner` agent
