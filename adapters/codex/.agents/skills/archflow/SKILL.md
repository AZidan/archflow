...
- `.codex/archflow/skills/archflow/instructions.md` — agent-neutral base instructions
- `.codex/archflow/skills/archflow/phases/` — per-phase instruction files
- `.codex/archflow/skills/archflow/schemas/` — roadmap / release / backlog / history schemas
- `.codex/archflow/skills/archflow/workflow.md` — git branching strategy
- `.codex/archflow/skills/archflow/base-dsl-structure.yaml` — DSL template for design artifacts
- `.codex/archflow/skills/archflow/mcp-registry.yaml` — curated MCP server registry
- `.codex/archflow/skills/archflow/design-systems/` — design-system reference files, one plain
  markdown file per system (not skills, not commands — loaded by explicit path only)
- `.codex/archflow/scripts/migrate.py` — v1.0 → v2.0 migration engine
