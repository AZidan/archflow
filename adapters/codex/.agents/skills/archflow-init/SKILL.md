...
> Invoke with `$archflow-init`. Arguments are the text after the mention.
...
```
Then load and follow `.codex/archflow/commands/onboard.md`.
...
2. **Copy `workflow.md` into the project's `.archflow/`:**
   - Source: `.codex/archflow/skills/archflow/workflow.md` (the plugin's install path)
...
- `.codex/archflow/skills/archflow/phases/` → `.archflow/phases/`
- `.codex/archflow/skills/archflow/schemas/` → `.archflow/schemas/`
- `.codex/archflow/skills/archflow/design-systems/` → `.archflow/design-systems/`
- `.codex/archflow/skills/archflow/stacks/` → `.archflow/stacks/`
- `.codex/archflow/skills/archflow/workflow.md` → `.archflow/workflow.md`
- `.codex/archflow/skills/archflow/test-accounts.example.yaml` → `.archflow/`
...
1. **Ask the platform**, then run the picker. Both live in one place: read
   `.codex/archflow/commands/design.md` and follow **Step 3 — `pick`** inline. It asks the
