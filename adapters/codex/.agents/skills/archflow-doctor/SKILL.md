...
**Newer release.** On hosts other than Codex the session-start hook also reports when a newer
...
Codex updates the plugin through its marketplace, so say nothing there.
