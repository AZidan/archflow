---
name: archflow-agent-ux-designer
description: "Archflow role: ux-designer. Load when an Archflow phase or skill delegates to this role. User flows, wireframes and theme tokens derived from the project's chosen design system, never invented. Runs in Phase 2, and again for per-screen design changes. Outputs to design-artifacts/."
---
