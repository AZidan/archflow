---
name: archflow-agent-api-contract-architect
description: "Archflow role: api-contract-architect. Load when an Archflow phase or skill delegates to this role. Owns the project's API contract, the single source of truth that api-engineer and ui-engineer both build against with zero tolerance for deviation. Runs in Phase 2.5, after wireframes and before any implementation begins."
---
