---
name: archflow-groom
description: "Use ONLY when the user asks for $archflow-groom or \"archflow groom\". Detail or refine a story: acceptance criteria, subtasks, gates. Works on a backlog stub or a story already in a release"
---
...
Argument (`the text the user wrote after the skill name`): optional story id (e.g. `S2-11`). Empty → list stubs and ask which to groom.
