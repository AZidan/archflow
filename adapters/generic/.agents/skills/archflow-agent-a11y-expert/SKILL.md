---
name: archflow-agent-a11y-expert
description: "Archflow role: a11y-expert. Load when an Archflow phase or skill delegates to this role. Accessibility review gate. Audits UI code against WCAG 2.1 AA and the design system's accessibility anti-patterns, reporting every violation with file, line and the fix that resolves it. On-demand, since no phase dispatches it yet."
---
