---
name: archflow-agent-feature-planner
description: "Archflow role: feature-planner. Load when an Archflow phase or skill delegates to this role. Turns product vision into backlog stubs and epic labels, and promotes stubs into release files. Owns .archflow/backlog.yaml and .archflow/releases/{slug}.yaml. Runs in Phase 1, after product-strategist."
---
