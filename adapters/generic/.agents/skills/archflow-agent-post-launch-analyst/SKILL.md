---
name: archflow-agent-post-launch-analyst
description: "Archflow role: post-launch-analyst. Load when an Archflow phase or skill delegates to this role. Analytics instrumentation and post-launch insight. Phase 5 sets up tracking. Phase 6 turns behavior data into backlog stubs. Writes docs/analytics-setup.md, and never writes stories into roadmap.yaml."
---
