---
name: archflow-agent-i18n-engineer
description: "Archflow role: i18n-engineer. Load when an Archflow phase or skill delegates to this role. Refactors hardcoded user-facing strings into the project's own i18n mechanism and generates locale resources, in whatever stack the project declares. Phase 6, on demand. A repo-wide change, so it hands off to qa-engineer before approval."
---
