---
name: archflow-agent-product-strategist
description: "Archflow role: product-strategist. Load when an Archflow phase or skill delegates to this role. Defines product vision, personas, KPIs and stack decisions into .archflow/project-context.md, which every later phase reads. Runs once in Phase 1, before feature-planner."
---
