---
name: archflow-agent-qa-engineer
description: "Archflow role: qa-engineer. Load when an Archflow phase or skill delegates to this role. Tests every platform in whatever test stack the project declares, discovering it from the repo when the stack is unset. Runs AFTER ui-engineer and api-engineer complete a story and BEFORE pm-reviewer. Enforces the design system's anti-patterns and API-contract compliance as blocking gates."
---
