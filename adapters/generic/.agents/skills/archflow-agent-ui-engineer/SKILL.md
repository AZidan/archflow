---
name: archflow-agent-ui-engineer
description: "Archflow role: ui-engineer. Load when an Archflow phase or skill delegates to this role. Builds the user interface in whatever stack the project declares, for web or mobile. Runs in Phase 3 in parallel with api-engineer. Bound by the project's design system and its API contract."
---
