---
name: archflow-agent-doc-writer
description: "Archflow role: doc-writer. Load when an Archflow phase or skill delegates to this role. Human-facing documentation. Onboarding guides, API reference and README. Never creates or edits the API contract, which api-contract-architect owns. On-demand, since no phase dispatches it yet."
---
