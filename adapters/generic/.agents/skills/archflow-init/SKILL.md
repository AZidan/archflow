...
```
Then load and follow `.agents/archflow/commands/onboard.md`.
...
2. **Copy `workflow.md` into the project's `.archflow/`:**
   - Source: `.agents/archflow/skills/archflow/workflow.md` (the plugin's install path)
...
- `.agents/archflow/skills/archflow/phases/` → `.archflow/phases/`
- `.agents/archflow/skills/archflow/schemas/` → `.archflow/schemas/`
- `.agents/archflow/skills/archflow/design-systems/` → `.archflow/design-systems/`
- `.agents/archflow/skills/archflow/stacks/` → `.archflow/stacks/`
- `.agents/archflow/skills/archflow/workflow.md` → `.archflow/workflow.md`
- `.agents/archflow/skills/archflow/test-accounts.example.yaml` → `.archflow/`
...
1. **Ask the platform**, then run the picker. Both live in one place: read
   `.agents/archflow/commands/design.md` and follow **Step 3 — `pick`** inline. It asks the
