...
**Newer release.** On hosts other than your coding agent the session-start hook also reports when a newer
...
your coding agent updates the plugin through its marketplace, so say nothing there.
