...
Command bodies live in `.agents/archflow/commands/<name>.md`. When you need to run one from
...
- `.agents/archflow/skills/archflow/instructions.md` — agent-neutral base instructions
- `.agents/archflow/skills/archflow/phases/` — per-phase instruction files
- `.agents/archflow/skills/archflow/schemas/` — roadmap / release / backlog / history schemas
- `.agents/archflow/skills/archflow/workflow.md` — git branching strategy
- `.agents/archflow/skills/archflow/base-dsl-structure.yaml` — DSL template for design artifacts
- `.agents/archflow/skills/archflow/mcp-registry.yaml` — curated MCP server registry
- `.agents/archflow/skills/archflow/design-systems/` — design-system reference files, one plain
  markdown file per system (not skills, not commands — loaded by explicit path only)
- `.agents/archflow/scripts/migrate.py` — v1.0 → v2.0 migration engine
...
`$archflow-status`: read and follow `.agents/archflow/commands/status.md`.
