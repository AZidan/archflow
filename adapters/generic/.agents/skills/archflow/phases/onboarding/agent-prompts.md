...
**Dispatch via:** doing the work directly
...
**Dispatch via:** exploring the codebase read-only yourself
...
**Dispatch via:** loading the `archflow-agent-product-strategist` skill and performing that role yourself (no sub-agent runtime)
...
**Dispatch via:** loading the `archflow-agent-ux-designer` skill and performing that role yourself (no sub-agent runtime)
...
**Dispatch via:** loading the `archflow-agent-api-contract-architect` skill and performing that role yourself (no sub-agent runtime)
...
**Dispatch via:** loading the `archflow-agent-dsl-generator` skill and performing that role yourself (no sub-agent runtime)
...
**Dispatch via:** loading the `archflow-agent-feature-planner` skill and performing that role yourself (no sub-agent runtime)
