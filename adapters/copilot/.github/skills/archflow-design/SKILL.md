...
description: "Use ONLY when the user asks for /archflow-design or \"archflow design\". The project's design system, and per-story screen design that clears a story's design gate"
---
...
- Design-system files live in `.archflow/design-systems/`, copied there by `/archflow-init` and
  `/archflow-onboard` from `.github/archflow/skills/archflow/design-systems/`. If the
