---
name: archflow-issue
description: "Use ONLY when the user asks for /archflow-issue or \"archflow issue\". Record a defect against a story in the active release, list what is open, or defer a minor one to the backlog"
---
