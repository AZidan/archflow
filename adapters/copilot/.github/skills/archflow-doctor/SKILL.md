...
**Newer release.** On hosts other than Copilot the session-start hook also reports when a newer
...
Copilot updates the plugin through its marketplace, so say nothing there.
