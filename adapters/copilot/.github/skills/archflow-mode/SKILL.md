---
name: archflow-mode
description: "Use ONLY when the user asks for /archflow-mode or \"archflow mode\". Show or switch ceremony mode: quick (solo, light gates) or full (team, strict gates)"
---
...
Argument (`the text the user wrote after the skill name`): optional target mode `quick` or `full`. Empty → show the current mode.
