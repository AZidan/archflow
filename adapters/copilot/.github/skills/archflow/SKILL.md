...
Command bodies live in `.github/archflow/commands/<name>.md`. When you need to run one from
...
- `.github/archflow/skills/archflow/instructions.md` — agent-neutral base instructions
- `.github/archflow/skills/archflow/phases/` — per-phase instruction files
- `.github/archflow/skills/archflow/schemas/` — roadmap / release / backlog / history schemas
- `.github/archflow/skills/archflow/workflow.md` — git branching strategy
- `.github/archflow/skills/archflow/base-dsl-structure.yaml` — DSL template for design artifacts
- `.github/archflow/skills/archflow/mcp-registry.yaml` — curated MCP server registry
- `.github/archflow/skills/archflow/design-systems/` — design-system reference files, one plain
  markdown file per system (not skills, not commands — loaded by explicit path only)
- `.github/archflow/scripts/migrate.py` — v1.0 → v2.0 migration engine
...
`/archflow-status`: read and follow `.github/archflow/commands/status.md`.
