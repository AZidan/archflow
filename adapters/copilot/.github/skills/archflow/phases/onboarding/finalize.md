...
2. **Copy workflow.md, phases, schemas and design-systems into the project's `.archflow/`:**
   - Copy `.github/archflow/skills/archflow/workflow.md` → `.archflow/workflow.md`
   - Copy `.github/archflow/skills/archflow/phases/` → `.archflow/phases/` (skip files that already exist)
   - Copy `.github/archflow/skills/archflow/schemas/` → `.archflow/schemas/` (skip files that already exist)
   - Copy `.github/archflow/skills/archflow/design-systems/` → `.archflow/design-systems/` (skip files that already exist; skip the whole directory for `backend_only`)
   - Copy `.github/archflow/skills/archflow/stacks/` → `.archflow/stacks/` (skip files that already exist)
   - Copy `.github/archflow/skills/archflow/test-accounts.example.yaml` → `.archflow/` (skip if present)
