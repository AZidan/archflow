...
function main() {
  ...
  // Host shell tools: Claude Code "Bash", Codex "Bash", Gemini CLI "run_shell_command", OpenCode "bash".
  if (!["Bash", "bash", "run_shell_command"].includes(input.tool_name)) process.exit(0);
