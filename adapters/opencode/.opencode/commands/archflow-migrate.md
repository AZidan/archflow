...
The migration is performed by **`.opencode/archflow/scripts/migrate.py`**, which
...
```bash
python3 .opencode/archflow/scripts/migrate.py --path <project-root> --dry-run
```
...
```bash
python3 .opencode/archflow/scripts/migrate.py --path <project-root> --apply --active <sprint-id>
```
