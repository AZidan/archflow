...
2. **Copy `workflow.md` into the project's `.archflow/`:**
   - Source: `.opencode/archflow/skills/archflow/workflow.md` (the plugin's install path)
...
- `.opencode/archflow/skills/archflow/phases/` → `.archflow/phases/`
- `.opencode/archflow/skills/archflow/schemas/` → `.archflow/schemas/`
- `.opencode/archflow/skills/archflow/design-systems/` → `.archflow/design-systems/`
- `.opencode/archflow/skills/archflow/stacks/` → `.archflow/stacks/`
- `.opencode/archflow/skills/archflow/workflow.md` → `.archflow/workflow.md`
- `.opencode/archflow/skills/archflow/test-accounts.example.yaml` → `.archflow/`
