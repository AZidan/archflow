...
- `.opencode/archflow/skills/archflow/instructions.md` — agent-neutral base instructions
- `.opencode/archflow/skills/archflow/phases/` — per-phase instruction files
- `.opencode/archflow/skills/archflow/schemas/` — roadmap / release / backlog / history schemas
- `.opencode/archflow/skills/archflow/workflow.md` — git branching strategy
- `.opencode/archflow/skills/archflow/base-dsl-structure.yaml` — DSL template for design artifacts
- `.opencode/archflow/skills/archflow/mcp-registry.yaml` — curated MCP server registry
- `.opencode/archflow/skills/archflow/design-systems/` — design-system reference files, one plain
  markdown file per system (not skills, not commands — loaded by explicit path only)
- `.opencode/archflow/scripts/migrate.py` — v1.0 → v2.0 migration engine
...
`/archflow-status`: read and follow `.opencode/archflow/commands/status.md`.
