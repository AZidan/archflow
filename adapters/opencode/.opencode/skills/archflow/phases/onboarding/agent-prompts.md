...
**Dispatch via:** the `task` tool targeting the built-in `general` subagent
...
**Dispatch via:** the `task` tool targeting the built-in `explore` subagent (read-only)
...
**Dispatch via:** the `task` tool targeting the `product-strategist` subagent
...
**Dispatch via:** the `task` tool targeting the `ux-designer` subagent
...
**Dispatch via:** the `task` tool targeting the `api-contract-architect` subagent
...
**Dispatch via:** the `task` tool targeting the `dsl-generator` subagent
...
**Dispatch via:** the `task` tool targeting the `feature-planner` subagent
