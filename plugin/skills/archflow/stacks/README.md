...
The agents carry no technology of their own. They read `stack:` from `.archflow/project-settings.yaml`
...
afterwards — once `stack:` is written to `project-settings.yaml`, that is the only source of truth.
