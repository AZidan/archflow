...
**Newer release.** On hosts other than Claude Code the session-start hook also reports when a newer
...
Claude Code updates the plugin through its marketplace, so say nothing there.
